...
from apps import home, basic_intro, extensive_intro, data_cleaning_and_presentaion, environment, regression, lab_preformace, temporal, conclusion # import your app modules here
...
app.add_app("Temporal Data Analysis", temporal.app)
