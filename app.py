...
from apps import home, basic_intro, extensive_intro, data_cleaning_and_presentaion, environment, regression, lab_preformace, temporal # import your app modules here
